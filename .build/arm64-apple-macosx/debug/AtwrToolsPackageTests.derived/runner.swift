...
extension SwiftPMXCTestObserver: XCTestObservation {
    var testOutputPath: String {
        return "/Users/baiwei/orca/workspaces/50_工作流/aitextwatermarkremover外链发布/外链发布 skill/包生态外链发布（publish-package-backlinks）/runs/aitextwatermarkremover-tools/.build/arm64-apple-macosx/debug/testOutput.txt"
    }
